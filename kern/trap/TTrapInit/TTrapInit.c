...
void trap_init(unsigned int cpu_idx)
{
    ...
    trap_handler_register(cpu_idx, T_PGFLT, exception_handler);  // dispatched within
    ...
    trap_handler_register(cpu_idx, T_IRQ0 + IRQ_SPURIOUS, interrupt_handler); // dispatched within
